      ...
      if (filePath.includes("portal.html")) {
        ...
        const promises = Array.from(includeElements).map(async (el) => {
          ...
          try {
            ...
            el.innerHTML = componentResponse.ok
        ...
        filePath.includes("portfolio.html") &&
        typeof initPortfolio === "function"
      ) {
        initPortfolio();
        if (typeof initMainSite === "function") initMainSite(); // Keeps scroll-to-top/year active
